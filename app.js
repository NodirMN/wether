...
$(function () {
    ...
    $.getJSON('https://ipinfo.io', function (data) {
        ...
        $.getJSON(`https://api.openweathermap.org/data/2.5/weather?${q}`, function (data) {
            fetchData(data);
            $('.wait').hide();
            setTimeout(function () {
                $('.msg').fadeIn(1000).fadeOut(10000);
            }, 3000);
        });
        ...
        function fetchData(data) {
            ...
            $('body').css('backgroundImage', "url('https://raw.githubusercontent.com/mostafazke/weatherApp/master/img/" + background + "')");
            if (dayCon === 'd') {
